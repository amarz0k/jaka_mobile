...
abstract class $MessageEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String senderId, String receiverId, String text, String sentAt});
}
...
class _$MessageEntityImpl implements _MessageEntity {
  ...
  @override
  String toString() {
    return 'MessageEntity(senderId: $senderId, receiverId: $receiverId, text: $text, sentAt: $sentAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, senderId, receiverId, text, sentAt);
...
abstract class _MessageEntity implements MessageEntity {
  const factory _MessageEntity(
      ...
      required final String sentAt}) = _$MessageEntityImpl;
